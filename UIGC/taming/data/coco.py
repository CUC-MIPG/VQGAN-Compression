...
# add by xnf, custom data location

class CocoBase_Custom(Dataset):
    """needed for (image, caption, segmentation) pairs"""
    def __init__(self, size=None, dataroot="", datajson="", stuffroot="", onehot_segmentation=False, use_stuffthing=False,
                 crop_size=None, force_no_crop=False, given_files=None):
        self.split = self.get_split()
        self.size = size
        if crop_size is None:
        ...
        if self.stuffthing:
            ...
            self.segmentation_prefix = (
                os.path.join(stuffroot, "stuff_val2017_pixelmaps") if
                data_json.endswith("captions_val2017.json") else 
                os.path.join(stuffroot, "stuff_train2017_pixelmaps"))
...
class CocoImagesAndCaptionsTrain_Custom(CocoBase_Custom):
    """returns a pair of (image, caption)"""
    def __init__(self, size, 
                 dataroot="data/coco/train2017",
                 datajson="data/coco/annotations/captions_train2017.json",
                 stuffroot="",
                 onehot_segmentation=False, use_stuffthing=False, crop_size=None, force_no_crop=False):
        super().__init__(size=size,
                         dataroot=dataroot,
                         datajson=datajson,
                         stuffroot=stuffroot,
...
class CocoImagesAndCaptionsValidation_Custom(CocoBase_Custom):
    """returns a pair of (image, caption)"""
    def __init__(self, size, 
                 dataroot="data/coco/val2017",
                 datajson="data/coco/annotations/captions_val2017.json",
                 stuffroot="",
                 onehot_segmentation=False, use_stuffthing=False, crop_size=None, 
                 force_no_crop=False, given_files=None):
        super().__init__(size=size,
                         dataroot=dataroot,
                         datajson=datajson,
                         stuffroot=stuffroot,
